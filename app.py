...
state_response = requests.get(f"https://cdn-api.co-vin.in/api/v2/admin/location/states".format(header))
...
def run():
    img1 = Image.open('./meta/vac.jpg')
    img1 = img1.resize((470,325))
    st.image(img1,use_column_width=False)
    st.title("Covid-19 Vaccination Slot Finder💉")

    Intakhab = f'<a href="https://github.com/intakhab1">Developed by @Intakhab</a>'
    ...
    if choice == 'Search by District':
        ...
        ## Area Pin
        area_pin = st.text_input('Enter your Area Pin-Code Eg.110080')
        ## Age
        age_display = ['18 & Above','18-45', '45+']
        age = st.selectbox("Your Age", age_display)
        age_val = 0
